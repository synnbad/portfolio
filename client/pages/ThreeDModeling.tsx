        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              I use Blender to create immersive 3D environments and assets for storytelling and experimentation.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
            ...
            <p className="text-center text-gray-600 mt-4">
              🎨 <a href="https://sketchfab.com/yourprofile" target="_blank" rel="noopener noreferrer" className="hover:text-portfolio-primary">View more on Sketchfab</a>
            </p>
          </div>
        </div>
      </div>
